...
*/
console.log('task 1b', createMenuItem('pancakes', 8, 'Brunch'));
console.log('task 1b', createMenuItem('pizza', 4, 'Lunch'));
console.log('task 1b', createMenuItem('candy', 2, 'Dessert'));
...
reviews.push({name: 'Brit', rating: 5, feedback: 'this place is great! good enviroment'});
...
function addReview(array, name, rating, feedback){
  console.log(array, name, rating, feedback)
  const newReview = {
    name: name,
    rating: rating,
    feedback: feedback
